...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
            """
            It initializes a KNNimputer object with the parameters specified in thetraining pipeline .py file and returns a pipeline object with knn imputer as the first step
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
          ...
          transformerd_input_train_feature=preprocessor_object.transform(input_feature_train_df)

          transformerd_input_test_feature=preprocessor_object.transform(input_feature_test_df)
